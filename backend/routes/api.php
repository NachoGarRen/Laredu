...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/courses/{id}', [CourseController::class, 'show']); // Mostrar curso por ID
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/roles/{roleId}/remove-permission', [PermissionController::class, 'removePermission']);
});